...
export default function MintPage() {
  ...
  let bodyContent = (
    <div className="flex flex-col justify-center">
      ...
      <div className="mt-32 flex items-center justify-center flex-wrap flex-1">
        {nfts
          .filter(
            (nft) =>
              !nft.contract?.isSpam && nft.contract?.openSeaMetadata?.imageUrl
          )
          .map((nft, index: number) => (
            <Avatar
              ...
              className={cn(
                ...
                `sm:absolute sm:bottom-[${Math.round(Math.random() * 100)}px] sm:right-[${Math.round(Math.random() * 100)}px]`,
